                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-accordion-merged"></i><span class="hide-menu">Tables</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="#">Afficher Admins</a></li>
                                <li><a href="#">Afficher Clients</a></li>
                                <li><a href="#">Afficher Tableaux</a></li>
                                <li><a href="#">Afficher Cadeaux</a></li>
                                <li><a href="#">Afficher Evenements</a></li>
