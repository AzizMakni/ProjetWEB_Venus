                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-duration="1500ms">
                        <div class="product-one__single">
                            <div class="product-one__image">
                                <img src="<?php echo $row['image']; ?>" alt="Awesome Image" width="150" height="300" />
                            </div><!-- /.product-one__image -->
                            <div class="product-one__content">
                                <div class="product-one__content-left">
                                    <h3 class="product-one__title">
                                        <a href="product-details.html"><?php echo $row['nom']; ?></a>
                                ...
                                <a href="AjouterPanier.php?id=<?PHP echo $row['id']; ?>&prix=<?php echo $row['prix']; ?>&type=cadeaux" data-toggle="tooltip" data-placement="top" title="Ajouter Panier" class="product-one__cart-btn"><i class="egypt-icon-supermarket"></i></a>
