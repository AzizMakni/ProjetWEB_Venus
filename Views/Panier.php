    ...
    <div class="page-wrapper">
                        ...
                        <table class="cart-table">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td class="price"><?php echo $row['prix_total']; ?> TND</td>
                    ...
                    <div class="row justify-content-between">
                        <div class="col-lg-12">
                            <div class="cart-update__button-box">
                                ...
                                <input class="thm-btn cart-update__btn cart-update__btn-three" type="button" value="Acheter" name="achat" id="achat">
        ...
        <footer class="site-footer">
            <div class="container">
                ...
                <p class="site-footer__copy">Copyrights &copy; 2021 Venus All Rights Reserved.</p>
                <!-- /.site-footer__copy -->
            </div><!-- /.container -->
        </footer><!-- /.site-footer -->
    </div><!-- /.page-wrapper -->
